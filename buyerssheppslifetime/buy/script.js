...
function run() {
	...
	if(main=="válida") {
		...
		dias = new Date()
		gdate = dias.getDate()
		gmonth = dias.getMonth()
		gyear = dias.getFullYear()
		...
		totdias=(parseInt(age)*365)
		totdias+=age/4
		totdias=parseInt(totdias)+gdate+m+n
		document.forms[0].answer.value="" + totdias +" dias "
		...
		if(main=="válida") {
			...
			idia=(yy + n + fours - hunds + fhunds) % 7;
			idia=parseInt(idia)
			
			switch(idia) {
				case 1 : document.forms[0].age.value +=" nasceu em um Domingo" ; break
				case 2 : document.forms[0].age.value +=" nasceu em uma Segunda-Feira" ; break
				case 3 : document.forms[0].age.value +=" nasceu em uma Terça-Feira" ; break
				case 4 : document.forms[0].age.value +=" nasceu em uma Quarta-Feira" ; break
				case 5 : document.forms[0].age.value +=" nasceu em uma Quinta-Feira" ; break
				case 6 : document.forms[0].age.value +=" nasceu em uma Sexta-Feira" ; break
				case 7 : document.forms[0].age.value +=" nasceu em uma Sábado" ; break
				case 0 : document.forms[0].age.value +=" nasceu em um Sábado" ; break
			}
		...
		if(((bdia==366)&&(leapyear(yy)))||((bdia==365)&&(!leapyear(yy)))) {
			document.forms[0].bdia.value="hoje é seu aniversário!"
			alert("Feliz Aniversário!")
		} else {
			document.forms[0].bdia.value=bdia+" dias "+ nhour+" horas "+nmin+" minutos "+nsec+" segundos"
			setTimeout("run()",1)
		}
	...
	setInterval(() => {
		var x = document.getElementById('progress').value = age;
